...
// console.log("profile id:",req.body.record.profile_id)
//     sql = `UPDATE ${table_name} SET task_title = '${req.body.record.task_title}', task_status = '${req.body.record.task_status}', reviewer_task_status = '${req.body.record.reviewer_task_status}', reviewer_profile_id = ${req.body.record.reviewer_profile_id}, task_role = ${req.body.record.task_role},profile_id = ${req.body.record.profile_id}, modifiedDate = '${req.body.record.modifiedDate}' WHERE task_id=${task_id}`;
//     conn.query(sql, (error, result) => {
//         if (error) {
