...
const HistoricalRecords = () => {
    ...
    //     const updatedData = data.filter((row) => !selectedRowKeys.includes(row.task_id));
    //     setData(updatedData);
...
//         });
//         selectedRowKeys.forEach((key) => {
//             const selectedRow = data.find((row) => row.profile_id === key);
//             if (selectedRow) {
//                 const updatedRow = { ...selectedRow };
//                 updatedRow.profile_id = assignedTo;
//                 updatedRow.profile_role = 3;
...
//                 console.log("assigned to :", updatedRow.profile_id)
//         axios
...
//             // Update the profile ID for the selected task
//             axios
//                 .put(`${DOMAIN}/updatetask/${selectedRow.task_id}`, {
//                     id: selectedRow.task_id,
//                     record: updatedRow,
...
//             // Update the profile ID for the selected tagger's tasks
//             axios
//                 .put(`${DOMAIN}/updatetaskprofile/${selectedRow.profile_id}`, {
//                     id: selectedRow.profile_id,
//                     record: updatedRow,
